...
l1tLayer1Barrel = cms.EDProducer("L1TCorrelatorLayer1Producer",
    ...
    emClusters = cms.VInputTag(cms.InputTag('l1tPhase2GCTBarrelToCorrelatorLayer1Emulator', 'GCTBarrelDigiClustersToCorrLayer1')),
    hadClusters = cms.VInputTag(cms.InputTag('l1tPhase2GCTBarrelToCorrelatorLayer1Emulator', 'CaloPFDigiClusterToCorrLayer1')),
